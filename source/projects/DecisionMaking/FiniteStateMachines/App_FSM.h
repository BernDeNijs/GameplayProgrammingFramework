...
private:
	...
	//Datamembers
	// --AI--
	::FSMState::PatrolState* m_pPatrolState;
	::FSMState::ChaseState* m_pChaseState;
	::FSMState::SearchState* m_pSearchState;

	::FSMCondition::IsTargetVisible* m_pIsTargetVisible;
	::FSMCondition::IsTargetNotVisible* m_pIsTargetNotVisible;
	::FSMCondition::IsSearchingTooLong* m_pIsSearchingTooLong;
