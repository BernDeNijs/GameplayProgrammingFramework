...
void App_GraphTheory::Start()
{
	...
	const int id1 = m_pGraph->AddNode(new GraphNode(Vector2{ -10.f,-10.f }));
	const int id2 = m_pGraph->AddNode(new GraphNode(Vector2{ 50.f,30.f }));
...
{
	const GraphRenderingOptions renderOptions{ true,true,true,true };
	m_pGraphRenderer->RenderGraph(m_pGraph, renderOptions);
